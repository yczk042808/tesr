...
--[[
    local tmpStr = "$PCAS03,"..(gga or 1)..","..(gll or 0)..","..(gsa or 1)..","..(gsv or 1)..","..(rmc or 1)..","..(vtg or 0)..",0,0,0,0,,,0,0,,,,0".."*"
...
sys.timerStart(function()
    if not (rtos.get_version()):match("FLOAT") then
        sys.timerLoopStart(log.error,1000,"Please use a core version that supports FLOAT functionality")        
    end
end,5000)
]]
